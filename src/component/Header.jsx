...
const Header = () => {
  ...
  const handleRegister = async () => {
    try {
      ...
      if (error.response) {
        // Kesalahan dari server dengan respon HTTP yang dikembalikan
        console.error("Registrasi gagal. Respon server:", error.response.data);
      } else if (error.request) {
        // Permintaan dibuat tetapi tidak ada respons
        console.error("Tidak ada respons dari server. Cek koneksi atau URL.");
      } else {
        // Kesalahan lainnya
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg z-10 w-96">
            ...
            <div className="text-right">
              ...
              <button className="text-gray-500 ml-2" onClick={handleModalClose}>
                Close
              </button>
            </div>
          </div>
      ...
      {showRegisterModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg z-10 w-96">
            ...
            <div className="mb-4">
              <label htmlFor="activity" className="block text-gray-600">
                Aktivitas:
              </label>
              <input
                type="text"
